...
Se manca **`project-profile.md`**, non improvvisare: proponi il workflow `grg-profile`, oppure raccogli al volo i 3-4 dati che ti servono per rispondere adesso — settore, dati trattati, mercato (UE/extra-UE), criticità — e suggerisci la profilazione completa dopo. Non profilare e rispondere nello stesso turno: scegli quale viene prima, in base a quanto è urgente la domanda che ti hanno fatto.
