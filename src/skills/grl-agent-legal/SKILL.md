...
domanda che ti è arrivata: proponi di eseguire il workflow `grg-profile`, oppure — se la domanda
...
profilo non manca: non è pertinente. Non proporre `grg-profile` e non chiedere il modello di
